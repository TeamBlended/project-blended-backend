...
public class CommentController {
    ...
    @PostMapping()
    public ResponseEntity<CommentResponseDto> createComment(@RequestBody CommentRequestDto requestDto, @PathVariable Long postId , @AuthenticationPrincipal UserInfo user) {
    ...
    public ResponseEntity<CommentResponseDto> updateComment(@RequestBody CommentRequestDto requestDto, @PathVariable Long commentId, @AuthenticationPrincipal UserInfo user){
    ...
    public ResponseEntity<CommentResponseDto> deleteComment(@PathVariable Long commentId, @AuthenticationPrincipal UserInfo user){
